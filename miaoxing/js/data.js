...
var info="别称喵星人,性别男,九二年生,就读于南京大学金陵学院软件工程专业,主修C,C++,JAVA和数据库等,毕业后就职于上海梦创软件科技有限公司,该公司是一家主要致力于政府单位管理系统的开发的单位,在公司中负责将设计稿还原并与后端对接,后就职于南京名妆堂网络科技有限公司,担任运营助理一职,日常工作为数据分析,活动决策,流量监控,效果分析等";
var skill=[
	{
		name:'HTML+CSS',
		percent:'80'
